    ...
    <div className="page-fade">
              ...
              : data.followerChart?.length > 0
                ? <ResponsiveContainer width="100%" height={isMobile?180:220}>
                  <LineChart data={data.followerChart} margin={{ top:8, right:8, left:isMobile?-16:0, bottom:4 }}>
                    ...
                    <YAxis tick={{ fill:"rgba(255,255,255,0.2)", fontSize:9, fontFamily:"var(--fd)" }} axisLine={false} tickLine={false} width={isMobile?32:38} tickFormatter={v=>v.toLocaleString()} domain={[dataMin => Math.floor(dataMin * 0.98), 'auto']} />
      ...
      <section className="sec" style={{ background:"#050505", borderTop:"1px solid rgba(255,255,255,0.05)", textAlign:"center", paddingBottom:60 }}>
        <div style={{ fontFamily:"var(--fd)", lineHeight:.85, marginBottom:16, color:OR }}>
          <span style={{ fontSize:"clamp(100px,20vw,200px)" }}>ログ</span>
          <span style={{ fontSize:"clamp(44px,10vw,96px)" }}>は続く。</span>
        </div>
